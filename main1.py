...
class Ball:
 ...
 ###ive read and understand the purpose of this part of the code.
...
class MyGame(arcade.Window):
    ...
    ##i somewhat understand this on top
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if button == arcade.MOUSE_BUTTON_LEFT:
            self.ball.color = arcade.color.BLACK  ##color 

    def on_mouse_release(self, x, y, button, modifiers): ##moves it around 
        """
